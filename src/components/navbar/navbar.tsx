    ...
    return (
        <>
            <nav className="bg-gray-200 p-4 justify-between flex flex-row items-center">
                <h3 className={`${poppinsFont.className} text-2xl text-blue-500 font-semibold`}>Splitr</h3>
...
{NAV_LINKS.map((item, index) => {
                ...
                {/* dashboard */}
                <input type="button" value="Dashboard" className="bg-blue-800 text-white px-4 py-2 rounded-lg hover:bg-blue-800 cursor-pointer" />  
            </nav>
        </>
    );
}